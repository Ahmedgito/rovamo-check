...
const Footerwhite: React.FC = () => (
  <>
    {/* Footer - Light Theme */}
    <motion.footer className="md:ml-11 bg-[#E9E9E9]" {...fadeInUp}>
      <div className="mx-[10%]">
        <motion.div className="py-16 md:py-10" {...fadeInUp}>
          <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32" {...fadeInUp}>
            ...
            <motion.div {...fadeInUp}>
              <motion.h3 className="text-2xl mb-8 text-[#171717]" {...fadeInUp}>
              ...
              <motion.div className="relative max-w-md" {...fadeInUp}>
                <motion.input
                  ...
                  className="w-full bg-transparent border-b border-zinc-300 py-2 pr-12 text-[#171717] placeholder-gray-400 focus:outline-none focus:border-black transition-colors"
                  {...fadeInUp}
                />
              ...
              <motion.div className="mt-8" {...fadeInUp}>
                ...
                <motion.a
                  href="#directions"
                  className="text-[#171717] hover:text-[#0093D7] transition-colors"
                  {...fadeInUp}
                >
                  Get directions
                </motion.a>
              ...
              <motion.nav className="space-y-4 md:space-y-2 md:mt-0 text-left" {...fadeInUp}>
                {["Home", "Services", "Work", "About"].map((label, idx) => (
                  <motion.a
                    ...
                    className="block text-4xl sm:text-5xl md:text-7xl lg:text-7xl text-[#171717] hover:text-[#0093D7] transition-colors"
                    {...fadeInUp}
          ...
          <motion.div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-16 md:mt-10 pt-8 border-t border-zinc-300" {...fadeInUp}>
            <motion.p className="text-sm text-[#171717]" {...fadeInUp}>
