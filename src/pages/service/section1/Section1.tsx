...
const Section1Service: React.FC = () => (
    <section className="relative min-h-screen md:h-screen font-schibsted pt-0 md:pt-72 mb-20 bg-[#E9E9E9]">
        <BackgroundPaths />
        ...
        <div className="flex md:hidden flex-col justify-center text-center px-6 relative z-10 bg-[#E9E9E9]">
            <motion.h1
