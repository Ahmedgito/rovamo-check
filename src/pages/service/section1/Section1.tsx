...
const Section1Service: React.FC = () => (
    <section className="relative min-h-screen md:h-screen pt-0 md:pt-72 mb-20 bg-[#E9E9E9]">
        <BackgroundPaths />

        {/* Desktop Version (md and up) */}
        <div className="hidden md:flex relative z-10 font-schibsted w-full px-6 sm:px-10 md:px-[10%] flex-row items-start justify-between">
            <div className="flex flex-col items-start  md:ml-10 justify-center w-full max-w-full md:max-w-[70%]">
                ...
                >
                    <p className=" font-hanken sm:text-lg md:text-xl font-light leading-relaxed text-[#171717] mt-0 md:mt-4">
        ...
        <div className="flex md:hidden flex-col justify-center font-schibsted text-center px-6 relative z-10 bg-[#E9E9E9]">
            <motion.h1
            ...
            <motion.p
                ...
                transition={{ duration: 0.8, delay: 0.2 }}
            >
                <span>We combine strategy, design, and engineering to create transformative digital experiences that drive real business value.</span>
            </motion.p>
        </div>
        ...
        <div className="w-full px-6 sm:px-10 md:px-[12%] mt-12 md:mt-16">
            <div className="grid grid-cols-1 md:grid-cols-3 grid-flow-col-dense gap-y-10 md:gap-y-12 gap-x-0 ">
                {/* Research */}<div className="flex flex-col items-start text-left">
                    ...
                    <h3 className="text-lg md:text-xl font-base mb-2 font-schibsted  text-black">Research</h3>
                    <ul className="text-md md:text-md font-hanken  text-[#171717] font-light space-y-1">
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    <h3 className="text-lg md:text-xl font-base mb-2 font-schibsted  text-black">Strategy</h3>
                    <ul className="text-md md:text-md font-hanken text-[#171717] font-light space-y-1">
        ...
        <div className="w-full px-6 sm:px-10 md:px-[12%] mt-12 md:mt-16">
            <div className="grid grid-cols-1 md:grid-cols-3 grid-flow-col gap-y-10 md:gap-y-12 gap-x-0 ">
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    <h3 className="text-lg md:text-xl font-base font-schibsted  mb-2 text-black">Product design</h3>
                    <ul className="text-md font-hanken md:text-md text-[#171717] font-light space-y-1">
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    <h3 className="text-lg md:text-xl font-base mb-2 font-schibsted  text-black">Visual design</h3>
                    <ul className="text-md md:text-md font-hanken text-[#171717] font-light space-y-1">
