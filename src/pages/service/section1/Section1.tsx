...
const Section1Service: React.FC = () => (
    <section className="block min-h-[10vh] z-20 md:h-screen py-64 md:pt-72  bg-[#E9E9E9]">
        ...
        <div className="hidden md:flex z-20 font-schibsted w-full px-6 sm:px-10 md:px-[10%] flex-row items-start justify-between">
        ...
        <div className="flex md:hidden flex-col justify-center font-schibsted text-center px-6 z-10 bg-[#E9E9E9] pt-12">
            <motion.h1
