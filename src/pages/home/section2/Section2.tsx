...
const Section2Services: React.FC = () => (
  <>
    ...
    <section id="services" className="py-10 font-manrope font-[300]  md:ml-11 md:py-20">
      <div className="mx-[10%]">
        <div>
          {/* Section Header */}
          <div className="mb-16 md:mb-32">
            {/* Top Heading */}
            <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-[84px] leading-none text-blackPage.text">
              Designing for
              <br />
              impact
            </h2>
            ...
            <div className="flex flex-col md:flex-row md:items-start md:space-x-12">
              ...
              >
                <p className="text-lg font-manrope md:text-lg font-[300] leading-relaxed text-[#E9E9E9]">
